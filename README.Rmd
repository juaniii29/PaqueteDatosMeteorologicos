...
*`convertir_cf()`*: Toma un valor numerico en grados celsius y lo convierte a grados fahrenheit *`convertir_fc()`*: Toma un valor numerico en grados fahrenheit y lo convierte a grados celsius *`clasificar_temperatura()`*: Toma un valor numerico en grados celsius y lo clasifica dependiendo de su magnitud
